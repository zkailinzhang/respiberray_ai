    ...
    try:
        ...
        while (cap.isOpened() ):
            ...
            if len(bbox)!=0:
                ...
                cursor.execute(sql_bj,('渗油检测',1,dataimg,time_now))
                db.commit()
